...
Instructions-
 Please copy the solution (both 'index.htm' and 'airportBaggage.js') at same location.
 Launch index.htm file and click on button to find the optimized path.
...
the departing flights, and the bags to be routed.  The output is the optimal routing to get bags to their destinations.  Bags with a flight id of “ARRIVAL” are
